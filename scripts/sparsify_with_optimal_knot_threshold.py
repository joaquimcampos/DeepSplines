...
if __name__ == "__main__":
    ...
    # parse arguments
    parser = argparse.ArgumentParser(description='Sparsify ckpt model using an "optimal" slope '
    ...
    if acc_drop_threshold <= -1:
        raise argparse.ArgumentTypeError(f'{acc_drop_threshold} should be in (-1, 0).')
    ...
    print(f'\n=> Compute optimal threshold/sparsity for model: {base_model_name}.')
